...
- [pm2](https://github.com/Unitech/pm2) - Node.js 应用程序的管理器
...
- [clean-webpack-plugin](https://github.com/johnagan/clean-webpack-plugin) - 用于删除/清理构建文件夹
...
- [svelte](https://github.com/sveltejs/svelte) - 没有虚拟 DOM
...
- [vee-validate](https://github.com/logaretm/vee-validate) - Vue 基于模板的验证框架
...
- [handlebars](https://github.com/handlebars-lang/handlebars.js) -模板语言
